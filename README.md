...
- **<a href="https://github.com/bwNetFlow/bwnetflow_dosdetection" target="_blank">bwNetFlow volume-based DoS Detection</a>:** Provides a sample volume-based DoS Detection implementation based on protobuf converted NetFlow data.
